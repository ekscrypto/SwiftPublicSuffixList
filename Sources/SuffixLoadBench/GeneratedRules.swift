// Generated by SuffixLoadBench generate. Do not edit.

enum GeneratedRules {
    /// One rule per line, labels joined by '.' — no escapes needed
    /// because PSL labels never contain '.' or '"' or '\\'.
    static let raw: StaticString = """
ac
com.ac
edu.ac
gov.ac
